    ...
    <div className="h-full flex flex-col">
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-sm text-text-secondary mt-1">Manage store configuration and preferences</p>
        </div>
      </div>
      <div className="flex-1 flex flex-col items-center justify-center text-text-muted border-2 border-dashed border-border-light rounded-xl bg-card-white/50">
        <h3 className="text-lg font-medium text-text-primary mb-2">Settings Module</h3>
